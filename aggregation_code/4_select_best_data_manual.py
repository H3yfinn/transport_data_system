...
if import_manual_data_selection:
       ...
       previous_combined_data_concordance_manual = pd.read_csv('./intermediate_data/data_selection/{}_data_selection_manual.csv'.format(import_complete_FILE_DATE_ID))
       ...
       b = duplicates_manual.copy().reset_index()
       ...
       manual_index_rows = previous_combined_data_concordance_manual.copy()#[progress_csv.Dataset_selection_method=='Manual']
...
#save the duplicates file to a csv in case we need to use it later:
