...
def setup_paths_dict(FILE_DATE_ID, EARLIEST_date, LATEST_date, previous_FILE_DATE_ID=None,SINGULAR_ECONOMY_TO_RUN_PREV_DATE_ID=None,save_plotting_backups=True,previous_selections_file_path=None):
    ...
    #initial dfs:
    paths_dict['unfiltered_combined_data_pkl'] = os.path.join(paths_dict['intermediate_folder'], f'unfiltered_combined_data.pkl')
    paths_dict['unfiltered_combined_data_csv'] = os.path.join(paths_dict['intermediate_folder'], f'unfiltered_combined_data.csv')
