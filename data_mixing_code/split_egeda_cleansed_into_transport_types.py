...
#%%
#load egeda data
file_date = utility_functions.get_latest_date_for_data_file('intermediate_data/EGEDA/', 'model_input_9th_cleaned')
FILE_DATE_ID = 'DATE{}'.format(file_date)
model_input_9th_cleaned = pd.read_csv('intermediate_data/EGEDA/model_input_9th_cleaned' + FILE_DATE_ID + '.csv')
...
if missing.loc[(missing['Medium']=='ship') & (missing['Date']=='2017-12-31') & (missing['Economy']=='14_PE')] is not None:
    ...
    ship_peru_2017_new_value = model_input_9th_cleaned.loc[(model_input_9th_cleaned['Medium']=='ship') & (model_input_9th_cleaned['Date']=='2020-12-31') & (model_input_9th_cleaned['Economy']=='14_PE')]
...
EGEDA_merged['Dataset'] = 'EGEDA_split_into_transport_types_using_8th'
EGEDA_merged['Source'] = 'EGEDA_9th_cleansed'
...
EGEDA_merged_clean.to_csv('./intermediate_data/estimated/EGEDA_9th_cleaned_split_into_transport_types{}.csv'.format(FILE_DATE_ID), index=False)
#%%
analyse = True
if analyse:
    #DO ANALYSIS:
